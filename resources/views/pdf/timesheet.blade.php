...
<head>
    ...
    <style>
        ...
        .signature-section { 
            margin-top: 40px; 
            border-top: 2px solid #4caf50; /* Green border */
            padding-top: 20px;
        }
        .signature-line { 
            width: 300px; 
            border-bottom: 1px solid #4caf50; /* Green line */
...
<body>
    ...
    <div class="signature-section">
        <div class="notes">
            <p>The signatures on this time sheet attest to the fact that the percentage allocation by grants is a reasonable and true indication of the time and effort dedicated to each project for the period being reported.</p>
        </div>
        ...
        <div style="margin-top: 30px;">
            <p>Supervisor's verification: Name <span class="signature-line"></span> and Signature <span class="signature-line"></span></p>
        </div>
    </div>
